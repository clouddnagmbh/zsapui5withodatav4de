		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAPUI5 mit OData V4",
									"targetURL": "#atclouddnazsapui5withodatav4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnazsapui5withodatav4-display": {
								"semanticObject": "atclouddnazsapui5withodatav4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.zsapui5withodatav4",
									"url": sap.ui.require.toUrl("at/clouddna/zsapui5withodatav4")
								}
							}
						}
					}
